...
public class NewBeeMallGoodsController {
    ...
    public Result save(@RequestBody NewBeeMallGoods newBeeMallGoods) {
        if (!StringUtils.hasText(newBeeMallGoods.getGoodsName()) || !StringUtils.hasText(newBeeMallGoods.getGoodsIntro()) || Objects.isNull(newBeeMallGoods.getGoodsCategoryId()) || Objects.isNull(newBeeMallGoods.getGoodsSellStatus()) || !StringUtils.hasText(newBeeMallGoods.getGoodsCoverImg())) {
            return ResultGenerator.genFailResult("参数异常！");
        }
    ...
    public Result update(@RequestBody NewBeeMallGoods newBeeMallGoods) {
        if (Objects.isNull(newBeeMallGoods.getGoodsId()) || !StringUtils.hasText(newBeeMallGoods.getGoodsName()) || !StringUtils.hasText(newBeeMallGoods.getGoodsIntro()) || Objects.isNull(newBeeMallGoods.getGoodsCategoryId()) || Objects.isNull(newBeeMallGoods.getGoodsSellStatus()) || !StringUtils.hasText(newBeeMallGoods.getGoodsCoverImg())) {
            return ResultGenerator.genFailResult("参数异常！");
        }
